...
import com.amila.ecommerce.kafka.order.Product;
...
import static com.amila.ecommerce.email.EmailTemplates.*;
...
public class EmailService {
    ...
    public void sendPaymentSuccessEmail(
        ...
        messageHelper.setFrom("amilaprasadbandara1994@gmail.com");
        ...
        try{
            String htmlTemplate = templateEngine.process(templateName, contex);
